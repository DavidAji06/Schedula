...
export default function MonthlyCalendarGrid({ theme, onToggleTheme, view, onToggleView, events, setEvents, username, onLogout }) {
  ...
  return (
    <div className="month">
      ...
      {menuOpen && (
        <>
          <div className="ham-overlay" onClick={() => setMenuOpen(false)} />
          <div className="ham-sheet" role="dialog" aria-modal="true">
            <div className="ham-handle" />
            <button className="ham-item" type="button" onClick={() => { setMenuOpen(false); navigate("/"); }}>
              ← Home
            </button>
            <button className="ham-item" type="button" onClick={() => { setMenuOpen(false); onToggleView(); }}>
              📆 Switch to week view
            </button>
            <button className="ham-item" type="button" onClick={() => { setMenuOpen(false); setTodoOpen(true); }}>
              ✓ Tasks
            </button>
            <button className="ham-item ham-item--danger" type="button" onClick={() => { setMenuOpen(false); setLogoutConfirmOpen(true); }}>
              ⏻ Sign out
            </button>
          </div>
        </>
      ...
      <header className="month__topbar">
        ...
        <div className="month__actions">
          ...
          <button className="ham-trigger" type="button" onClick={() => setMenuOpen(true)} aria-label="Open menu">
            ☰
          </button>
        </div>
      </header>
